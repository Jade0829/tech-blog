...
| 구분 | 파일 평균 사이즈 | 파일 수 | 처리 속도 | 동기화 평균 시간 ( 300개 파일 ) | 배치 대기 시간 |
|-----|--------|---------|--------|---------|-------|
| 잔파일 | 314K | 10,000 | 242mb/s | 39s | 19m40s |
| 일반 파일 | 55M | 10,000 | 412mb/s | 0.32s | 2m42s |
...
&nbsp;
[^5]: RTO(Recovery Time Objective) : 업무의의 복구 목표 시간
