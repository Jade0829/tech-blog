...
[^4]: RPO(Recovery Point Objective, 복구 시점 목표) : 재해 복구에서 허용 가능한 최대 데이터 손실 시간을 의미합니다. 예를 들어 RPO가 1시간이면, 재해 발생 시 최대 1시간 전까지의 데이터는 복구 가능해야 합니다.
